    ...
    public class DALParcelasVenda
    {
        ...
        public void Incluir(ModeloParcelasVenda obj)
        {
            ...
            try
            {
                ...
                cmd.Parameters.Add("@pve_datapagto", MySqlDbType.Date);
                cmd.Parameters.Add("@pve_datavecto", MySqlDbType.Date);
        ...
        public void Alterar(ModeloParcelasVenda obj)
        {
            ...
            try
            {
                ...
                //cmd.Parameters.AddWithValue("@pve_datapagto", obj.pve_datapagto);
                //cmd.Parameters.AddWithValue("@pve_datavecto", obj.pve_datavecto);
                cmd.Parameters.Add("@pve_datapagto", MySqlDbType.DateTime);
                cmd.Parameters.Add("@pve_datavecto", MySqlDbType.DateTime);
                if (obj.pve_datapagto == null)
                {
                    cmd.Parameters["@pve_datapagto"].Value = DBNull.Value;
                }
        ...
        public DataTable Listagem()
        {
            ...
            MySqlDataAdapter da = new MySqlDataAdapter("Select * from parcelasvenda", DALDadosDoBanco.stringDeConexao);
            da.Fill(tabela);
            return tabela;
        }
        //-------------------------------------------------------------------------------------------------------------------
        ...
        {
            DataTable tabela = new DataTable();
            MySqlDataAdapter da = new MySqlDataAdapter("Select * from parcelasvenda where ven_cod =" +
        ...
        //MySqlDataAdapter da = new MySqlDataAdapter("Select CL.cli_nome, PA.pve_cod, PA.pve_datavecto, PA.pve_valor, PA.pve_status from parcelasvenda PA inner join cliente CL on (PA.cli_cod = CL.cli_cod) where PA.cli_cod = " + cli_cod + " PA.pve_status = 0", DALDadosDoBanco.stringDeConexao);
        //lista com o codigo do cliente
        public DataTable ListagemComFiltroDevedor(int cli_cod)
        {
            DataTable tabela = new DataTable();
            MySqlDataAdapter da = new MySqlDataAdapter("SELECT * from parcelasvenda where cli_cod = " + cli_cod + " and pve_status = 0",DALDadosDoBanco.stringDeConexao);          
            da.Fill(tabela);
            return tabela;
        }
        //-------------------------------------------------------------------------------------------------------------------
