namespace GUI
{
    partial class frmRelatorioSubCategoria
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.SubCategoriaComNomeDaCategoriaBindingSource = new System.Windows.Forms.BindingSource(this.components);
            ...
            ((System.ComponentModel.ISupportInitialize)(this.SubCategoriaComNomeDaCategoriaBindingSource)).BeginInit();
            ((System.ComponentModel.ISupportInitialize)(this.DTControleDeEstoque)).BeginInit();
            this.pnPrincipal.SuspendLayout();
            this.SuspendLayout();
            // 
            // SubCategoriaComNomeDaCategoriaBindingSource
            // 
            this.SubCategoriaComNomeDaCategoriaBindingSource.DataMember = "SubCategoriaComNomeDaCategoria";
            this.SubCategoriaComNomeDaCategoriaBindingSource.DataSource = this.DTControleDeEstoque;
            // 
            // DTControleDeEstoque
            // 
            ...
            this.label1.Text = "Pesquisar determinada Cor";
            // 
            // reportViewer1
            // 
            this.reportViewer1.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom)));
            reportDataSource1.Name = "DataSet1";
            reportDataSource1.Value = this.SubCategoriaComNomeDaCategoriaBindingSource;
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource1);
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "GUI.repRelatorioSubCategoria.rdlc";
            ...
            this.Text = "Relatorio Cor";
            this.Load += new System.EventHandler(this.frmRelatorioSubCategoria_Load);
            this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.frmRelatorioSubCategoria_KeyDown);
            ((System.ComponentModel.ISupportInitialize)(this.SubCategoriaComNomeDaCategoriaBindingSource)).EndInit();
        ...
        private System.Windows.Forms.BindingSource SubCategoriaComNomeDaCategoriaBindingSource;
