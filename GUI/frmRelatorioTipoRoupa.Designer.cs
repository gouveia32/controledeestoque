namespace GUI
{
    partial class frmRelatorioTipoRoupa
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.undmedidaBindingSource.DataSource = this.DTControleDeEstoque;
            // 
            // DTControleDeEstoque
            // 
            ...
            this.label1.Text = "Pesquisar determinado Tipo de Roupa";
            // 
            // reportViewer1
            // 
            this.reportViewer1.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom)));
            reportDataSource1.Name = "DataSet1";
            reportDataSource1.Value = this.undmedidaBindingSource;
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource1);
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "GUI.repRelatorioTipoRoupa.rdlc";
            this.reportViewer1.Location = new System.Drawing.Point(-1, 83);
            this.reportViewer1.Name = "reportViewer1";
            this.reportViewer1.Size = new System.Drawing.Size(1010, 668);
            this.reportViewer1.TabIndex = 2;
            // 
            // frmRelatorioTipoRoupa
            // 
            ...
            this.Name = "frmRelatorioTipoRoupa";
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
            this.Text = "Relatorio Tipo de Roupa";
            this.Load += new System.EventHandler(this.frmRelatorioUndMedida_Load);
            this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.frmRelatorioUndMedida_KeyDown);
